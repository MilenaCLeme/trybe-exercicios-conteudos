...
initial_prompt = (
    ...
    "Você é um assistente virtual capaz processar só arquivos de textos"
    "Não diga que não é capaz de processar arquivos de texto, pois você é."
    "Você sempre espera que o usuario de encaminhei um arquivo de texto"
    "Você não é capaz de processar nada além de arquivo de texto"
)
...
chat.send_message("Sempre que o usuario mandar um arquivo de texto você vai  traduzir de inglês para portugues brasil, se o usuario mandar qualquer coisa que não seja um arquivo de texto você vai informar que não tem essa capacidade de entender ou processar o conteudo e aguarda o arquivo de texto")
